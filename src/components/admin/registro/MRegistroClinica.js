...
const MRegistroClinica = ({
  openModal,
  setOpenModal,
  //metodo para obtener clinicas pasado desde registro clinica a este modal
  getClinica,
  //Dataselected es la data de la tabla que fue seleccionada, creo que la nombre asi en casi todos los modales
  dataSelected,
  setDataSelected,
  // el editar como dice su nombre es un booleano para saber si es editar o crear
  editar,
  setEditar,
}) => {
  ...
  // el obtener data seteo toda la data de la clinica en data para no tener que hacerlo en el html
  const obtenerData = () => {
    setData({
