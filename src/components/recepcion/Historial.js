...
const Historial = () => {
  ...
  const columnas = [
    ...
    },
    {
      ...
      cell: (e) => (
        <button className="table__tablebutton editar">
          <i class="far fa-file-pdf" onClick={()=> {generarDeclaracionJurada(); }}></i>{" "}
        </button>
      ),
    },
    {
      ...
      cell: (e) => (
        <button className="table__tablebutton editar">
          <i class="far fa-file-pdf" onClick={()=> {generarConsentimientoInformado();}}></i>{" "}
        </button>
      ),
    },
    {
      ...
      cell: (e) => (
        <button className="table__tablebutton editar">
          <i class="far fa-file-pdf" onClick={()=> {generarFichaCovid();}}></i>{" "}
        </button>
      ),
    },
  ];
