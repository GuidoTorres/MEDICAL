    ...
    return (
        ...
        <label className="titulo1 mt-2" htmlFor="">
            ...
            <div className="div1">
              <div className="mt-2" >
                ...
                <input
                  ...
                  onChange={e=> setFicha({ ...ficha, fechaNoti: e.target.value })}
                />
              </div>
              <div className="mt-2">
          ...
          <div className="paciente">
            <div className="div1">
              ...
              <div>
                ...
                <input
                  ...
                  aria-label="Username"
                  aria-describedby="basic-addon1"
                  onChange={e=> setFicha({ ...ficha, fechaNaci: e.target.value })}
            ...
            <label htmlFor="">12. Lugar donde el caso fue diagnosticado</label>
            <div style={{ display: "flex" }}>
              ...
              <input
                ...
                aria-describedby="basic-addon1"
                onChange={(e) =>
                  setFicha({ ...ficha, provincia: e.target.value })
                }
              />
              <input
                type="text"
                ...
                aria-describedby="basic-addon1"
                onChange={(e) =>
                  setFicha({ ...ficha, distrito: e.target.value })
                }
              />
            </div>
            ...
            <br />
            <label htmlFor="">13. Dirección de residencia actual</label>
            <input
              type="text"
              class="form-control"
              aria-label="Username"
              aria-describedby="basic-addon1"
              onChange={(e) =>
                setFicha({ ...ficha, direccion: e.target.value })
              }
            />
            <div className="mt-2" style={{ display: "flex" }}>
              <input
                ...
                aria-describedby="basic-addon1"
                onChange={(e) =>
                  setFicha({ ...ficha, dirPais: e.target.value })
                }
              />
              <input
                type="text"
          ...
          <div className="cuadroClinico">
            ...
            <br />
            <label htmlFor="">14. Fecha de inicio de sintomas:</label>
            <div className="div1">
              <input
                type="date"
                class="form-control"
            ...
            <label className="mt-2" htmlFor="">17. Aislamiento</label>
            <div className="div3">
            ...
            <div>
              <label htmlFor="">21. Sintomas:</label>
              <div class="form-check">
                <input
                  class="form-check-input"
                  type="checkbox"
            ...
            <div>
              ...
              <div class="form-check">
                <input
                  ...
                  id="flexCheckDefault"
                  onChange={(e) =>
                    setFicha({ ...ficha, signo1: e.target.checked })
                  }
                />
                <label class="form-check-label" for="flexCheckDefault">
                  Exudado faringeo
              ...
              <div class="form-check">
                <input
                  ...
                  id="flexCheckDefault"
                  onChange={(e) =>
                    setFicha({ ...ficha, signo2: e.target.checked })
                  }
                />
                <label class="form-check-label" for="flexCheckDefault">
              ...
              <div class="form-check">
                <input
                  ...
                  id="flexCheckDefault"
                  onChange={(e) =>
                    setFicha({ ...ficha, signo3: e.target.checked })
                  }
                />
                <label class="form-check-label" for="flexCheckDefault">
                  Convulsión
              ...
              <div class="form-check">
                <input
                  ...
                  id="flexCheckDefault"
                  onChange={(e) =>
                    setFicha({ ...ficha, signo4: e.target.checked })
                  }
                />
                <label class="form-check-label" for="flexCheckDefault">
                  Coma
              ...
              <div class="form-check">
                <input
                  ...
                  id="flexCheckDefault"
                  onChange={(e) =>
                    setFicha({ ...ficha, signo5: e.target.checked })
                  }
                />
                <label class="form-check-label" for="flexCheckDefault">
                  Disnea/taquipnea
              ...
              <div class="form-check">
                <input
                  ...
                  id="flexCheckDefault"
                  onChange={(e) =>
                    setFicha({ ...ficha, signo6: e.target.checked })
                  }
                />
                <label class="form-check-label" for="flexCheckDefault">
              ...
              <div class="form-check">
                <input
                  ...
                  id="flexCheckDefault"
                  onChange={(e) =>
                    setFicha({ ...ficha, signo7: e.target.checked })
                  }
                />
                <label class="form-check-label" for="flexCheckDefault">
              ...
              <div class="form-check">
                <input
                  ...
                  id="flexCheckDefault"
                  onChange={(e) =>
                    setFicha({ ...ficha, signo8: e.target.checked })
                  }
                />
                <label class="form-check-label" for="flexCheckDefault">
                  Otros, especificar
            ...
            <label htmlFor="">
              IV. Información de viaje y exposición en los 14 dias anteriores a
              la fecha de inicio de sintomas(antes de informar si es
              asintomatico)
            </label>

            <div>
              <label htmlFor="">24. Ocupación</label>
              <div class="form-check">
                <input
                  class="form-check-input"
                  type="checkbox"
          ...
          <div className="informacionViaje">
            <label htmlFor="">
              27. ¿Ha visitado algun establecimiento de salud en los 14 dias
            ...
            <label htmlFor="">
              29. ¿Ha tenido contacto con un caso confirmado o probable en los
              14 dias previos al inicio de sintomas?
            </label>
            ...
            <div>
              ...
              <label htmlFor="">
                Si la respuesta es si, registre el pais/departamento/localidad
                de exposición:
              </label>
              ...
              <input
                ...
                aria-describedby="basic-addon1"
                onChange={(e) =>
                  setFicha({ ...ficha, exposicion: e.target.value })
                }
              />
            </div>

            <label htmlFor="">
              30. ¿Ha visitado algun mercado donde se encuentre animales vivos
              en los 14 dias previos al inicio de síntomas?
            </label>
            ...
            <div class="form-check">
              <input
                ...
                id="flexCheckDefault"
                onChange={(e) =>
                  setFicha({ ...ficha, mercado1: e.target.checked })
                }
              />
              <label class="form-check-label" for="flexCheckDefault">
                Si
            ...
            <div class="form-check">
              <input
                ...
                id="flexCheckDefault"
                onChange={(e) =>
                  setFicha({ ...ficha, mercado2: e.target.checked })
                }
              />
              <label class="form-check-label" for="flexCheckDefault">
                No
            ...
            <div class="form-check">
              <input
                ...
                id="flexCheckDefault"
                onChange={(e) =>
                  setFicha({ ...ficha, mercado3: e.target.checked })
                }
              />
              <label class="form-check-label" for="flexCheckDefault">
                Desconocido
          ...
          <div className="laboratorio">
            <label htmlFor="">31. Fecha de toma de muestra:</label>
            ...
            <input
              ...
              aria-describedby="basic-addon1"
              onChange={(e) =>
                setFicha({ ...ficha, laboratorio1: e.target.value })
              }
            />

            <label htmlFor="">32. Tipo de muestra:</label>
            ...
            <input
              ...
              aria-describedby="basic-addon1"
              onChange={(e) =>
                setFicha({ ...ficha, laboratorio2: e.target.value })
              }
            />

            <label htmlFor="">33. Tipo de prueba:</label>
            ...
            <input
              ...
              aria-describedby="basic-addon1"
              onChange={(e) =>
                setFicha({ ...ficha, laboratorio3: e.target.value })
              }
            />

            <label htmlFor="">34. ¿Se realizó secuenciamiento?:</label>
            ...
            <input
              ...
              aria-describedby="basic-addon1"
              onChange={(e) =>
                setFicha({ ...ficha, laboratorio7: e.target.value })
              }
            />
          </div>

          <label className="mt-2" htmlFor="">VI. INVESTIGADOR</label>

          <div className="investigador">
            <label htmlFor="">54. Persona que llena la ficha:</label>
            ...
            <input
              ...
              aria-describedby="basic-addon1"
              onChange={(e) =>
                setFicha({ ...ficha, investigador: e.target.value })
              }
            />

            <label htmlFor="">55. Firma y sello:</label>
